About alibabacloud-tea-openapi-feedstock
========================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/alibabacloud-tea-openapi-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/alibabacloud-tea-openapi-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add alibabacloud-tea-openapi
# for installing globally
pixi global install alibabacloud-tea-openapi
```
...
It is possible to list all of the versions of `alibabacloud-tea-openapi` available on your platform:
...
```
pixi search alibabacloud-tea-openapi --channel conda-forge
```
